      ...
      <div className="section-container">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-2/5">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-portfolio-teal shadow-xl mx-auto">
                <img 
        ...
        <div className="text-center mt-16">
          <button 
            ...
            className="animate-bounce bg-white p-2 rounded-full shadow-md hover:shadow-lg transition-all duration-300"
